...
usage: python state_tile_map.py <csv> <out.png> [--value COL] [--title T] [--subtitle S] [--us LABEL] [--bins "0.4:under 0.4,0.8:0.4 to 0.8,..."] [--note N] [--source SRC] [--decimals 1]
...
ap.add_argument("--us", default="United States: 0.8"); ap.add_argument("--decimals", type=int, default=1)
...
.note{{font-size:13px;color:#6B7280;margin:10px 0 0}} .src{{font-size:13px;color:#6B7280;margin:14px 0 0}}
